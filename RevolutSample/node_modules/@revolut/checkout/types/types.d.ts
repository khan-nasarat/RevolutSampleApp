...
declare type WidgetPaymentsRevolutPayOptions = (CommonPaymentsRevolutPayOptions & CreateRevolutPaySessionParams) | (CommonPaymentsRevolutPayOptions & {
    sessionToken: string;
});
...
export interface PaymentsModuleRevolutPayInstance {
    mount: (target: string | HTMLElement, options: WidgetPaymentsRevolutPayOptions) => void;
    on: (event: RevolutPayEvents['type'], callback: (payload: RevolutPayEvents['payload']) => void) => void;
    destroy: () => void;
}
